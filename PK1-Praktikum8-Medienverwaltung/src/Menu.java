...
public class Menu {
    ...
    private final File f = new File("/home/mrmeep/IdeaProjects/Medien.ser");
    ...
    public void prntMenu(){
        ...
        System.out.println( "Medienverwaltung: \n" +
                            "\n" +
                            "1. Medien.Audio aufnehmen\n" +
                            "2. Medien.Bild aufnehmen\n" +
                            "3. Zeige alle Medien\n" +
                            "4. Medienliste in Datei schreiben\n" +
                            "5. Zeige neues Medien.Medium\n" +
                            "6. Bereche durschnittliches Erscheinungsjahr\n" +
                            "7. Speichern\n" +
                            "8. Laden\n" +
                            "9. Beenden");
    }
    ...
    public void action(int iSelection) {
        ...
        switch (iSelection){
            ...
            case 4: m.writeData(); break;
            case 5: m.sucheNeuesMedium(); break;
            case 6: System.out.println("Durchschnittliches Erscheinungsjahr: " + m.berechneErscheinungsjahr()); break;
            case 7: m.speichern(f); break;
            case 8: m.laden(f); break;
            case 9: this.exit = true; break;
